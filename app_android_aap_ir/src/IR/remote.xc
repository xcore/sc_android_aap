...
* more fantom remote controll presses. decrease it in order to decrease
...
const int simpleContextButtonValues[] = {
                  0x0,        PLAY_PAUSE, VOL_UP, VOL_DOWN,
                  NEXT_TRACK, LAST_TRACK, MENU,   BEGIN_FF,
                  BEGIN_RW,   END_FFRW,   POWER_OFF, UP_ARROW,
                  DOWN_ARROW, SELECT, SHUFFLE, VIDEO, REPEAT, POWER_ON, PAUSE
                  };
